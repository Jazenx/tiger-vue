<template>
  <section class="todoapp">
    ...
    <section class="main" v-show="todos.length">
      ...
      <ul class="todo-list">
        <tigerTodo @toggleTodo='toggleTodo' @editTodo='editTodo' @deleteTodo='deleteTodo' v-for="(todo, index) in filteredTodos" :key="index"
          :todo="todo"></tigerTodo>
      </ul>
    </section>
    <!-- footer -->
    <footer class="footer" v-show="todos.length">
      <span class="todo-count">
        <strong>{{ remaining | pluralize('item') }}</strong>
      </span>
      <ul class="filters">
...
const defaultList = [
  { text: 'star this repo', done: false },
  { text: 'fork this repo', done: false },
  { text: '吃一顿烧烤', done: false }
]
export default {
  components: { tigerTodo },
  data() {
    return {
      visibility: 'all',
      filters,
